    ...
    <div className="flex flex-col min-h-screen bg-white text-green-500">
      <header className="px-4 lg:px-6 h-14 flex items-center flex-wrap">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          <button className="text-[#007644] hover:text-green-400">Producto</button>
          <button className="text-[#007644] hover:text-green-400">Nosotros</button>
          <button className="text-[#007644] hover:text-green-400">Contacto</button>
        </nav>
      </header>
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-[#EEF0F4]">
          <div className="container px-4 md:px-6 mx-auto">
            <h2 className="text-3xl font-bold text-center mb-8 sm:text-4xl md:text-5xl lg:text-6xl/none text-[#124150]">Nuestro Producto</h2>
                    ...
                    <div className="flex flex-wrap justify-between items-center mb-4">
                      ...
                      <div className="flex space-x-2 mt-4 sm:mt-0">
                        ...
                        <label>
                          ...
                          <div className="w-9 h-9 border-2 rounded-lg flex items-center justify-center text-white bg-[#007644] peer-checked:font-semibold peer-checked:bg-green-500 peer-checked:border-green-500">
                            M
                          </div>
                        </label>
                        <label>
